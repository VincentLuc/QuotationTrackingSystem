...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <div class="navbar-inner" style="height:47px;">
    <ul class="nav" style="width:100%;">
      ...
      <li class="<%= (Request.QueryString["scope"] == "InformationUpdate") ? "active" : "" %>" style="width:155px;"><a href="/QuotationTrackingSystem/Enquiries/Index.aspx?scope=InformationUpdate" style="width:155px;">Informariton Updated</a></li>
