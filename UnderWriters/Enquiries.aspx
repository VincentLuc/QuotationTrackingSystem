...
<div class="navbar">
  <div class="navbar-inner">
    ...
    <ul class="nav">
      <li class="<%= (Request.QueryString["scope"] == null || Request.QueryString["scope"] == "Created") ? "active" : "" %>"><a href="/QuotationTrackingSystem/UnderWriters/Enquiries.aspx?scope=Created">New</a></li>
      <li class="<%= (Request.QueryString["scope"] == "Declined") ? "active" : "" %>" style="width:155px;"><a href="/QuotationTrackingSystem/UnderWriters/Enquiries.aspx?scope=Declined" style="width:155px;">Underwriter Declined</a></li>
